...
"""
    ...
    def "fails when dependency library does not specify the same target machines"() {
        ...
        failure.assertHasCause("The consumer was configured to find attribute 'org.gradle.usage' with value 'native-runtime', attribute 'org.gradle.native.debuggable' with value 'true', attribute 'org.gradle.native.optimized' with value 'false', attribute 'org.gradle.native.operatingSystem' with value 'linux', attribute 'org.gradle.native.architecture' with value 'x86-64' but no matching variant of project :greeter was found.")
    }
    ...
    def "fails compile and link against a library with different operating system family support"() {
        ...
        failure.assertHasCause """The consumer was configured to find attribute 'org.gradle.usage' with value 'native-runtime', attribute 'org.gradle.native.debuggable' with value 'true', attribute 'org.gradle.native.optimized' with value 'false', attribute 'org.gradle.native.operatingSystem' with value 'linux', attribute 'org.gradle.native.architecture' with value 'x86-64' but no matching variant of project :hello was found.
